...
function getAllVisitorsByCountry(data, country) {
    ...
    return data.filter(item => item.location === country)
...
export default function VisitorsAnalytics({ allVisitors }) {
    ...
    return <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7 pb-7 shadow sm:px-7.5 xl:col-span-4">
